...
description: Register and organize content in the knowledge base — save web link content, register algorithm training problems, and maintain topic indexes. Use this skill whenever the user shares a link to register, mentions a LeetCode or HackerRank problem, wants to save study material, bookmark an article, register an algorithm problem, add technical content to the knowledge base, or says things like "save this article", "add this to my notes", "register this problem", or "add to knowledge base".
...
1. **Fetch the content** — Use WebFetch to retrieve the page content. If the site blocks automated fetching (common with job boards or paywalled content), ask the user to open it in their browser and paste the relevant content.
