...
description: Generate persona-based resume variations — create resume versions focused on specific perspectives like frontend, backend, mobile, or fullstack. Use this skill whenever the user wants to create a resume focused on a particular area or perspective, NOT tied to a specific hiring process. Trigger on phrases like "frontend resume", "backend resume", "mobile resume", "tech lead resume", "resume PDF", "resume YAML", "career perspective", "professional profile variation", or any request to generate a resume from a different angle.
...
The resume generator lives at `.cursor/skills/generate-custom-resumes/resume-generator/`. See its [README](.cursor/skills/generate-custom-resumes/resume-generator/README.md) for full documentation.
